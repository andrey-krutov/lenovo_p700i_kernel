...
/*Lenovo-sw huangxuan modified 2012-04-09,begin*/
#if 1
#define VENDOR_ID		0x17EF
#else
#define VENDOR_ID		0x0BB4
#endif/*#if 1*/
/*Lenovo-sw huangxuan modified 2012-04-09,end*/
...
#define PRODUCT_STRING "Lenovo A789"
#elif defined(LENOVO_PROJECT_P700I)
#define PRODUCT_STRING "Lenovo P700i"
#elif defined(LENOVO_PROJECT_SEATTLE)
#define PRODUCT_STRING "Lenovo SEATTLE"
/*lenovo-sw qiyg project A570 = S560*/
#elif defined(LENOVO_PROJECT_A570)
#define PRODUCT_STRING "Lenovo S560"
#else
