...
/*Begin lenovo-sw wengjun1 add for p700i tpd common-mode interference 2012-6-26*/ 
#if defined(LENOVO_PROJECT_P700I)
	usb_connect_write_tpd();
#endif
/*End lenovo-sw wengjun1 add for p700i tpd common-mode interference 2012-6-26*/ 
