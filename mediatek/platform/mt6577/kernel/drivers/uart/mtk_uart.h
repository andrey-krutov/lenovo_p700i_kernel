...
/* lenovo yangyu3 modified buffer size to 2048 to fix S880i factory test problem begin */
#if defined(LENOVO_PROJECT_S880I) || defined(LENOVO_PROJECT_A570)
#define C_UART1_VFF_RX_SIZE (2048)  /*the size must be 8-byte alignment*/
#else
#define C_UART1_VFF_RX_SIZE (1024)  /*the size must be 8-byte alignment*/
#endif
/* lenovo yangyu3 modified buffer size to 2048 to fix S880i factory test problem end */
