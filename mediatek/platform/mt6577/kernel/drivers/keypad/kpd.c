...
#endif
/* lenovo-sw, add by zhouwl, 2012-6-29, add for line control earphone */
...
/* lenovo-sw, add by zhouwl, 2012-6-19, add for line control earphone */
#ifdef LENOVO_LINECONTROL_EARPHONE
	__set_bit(KEY_PLAYPAUSE, kpd_input_dev->keybit);
	__set_bit(KEY_PREVIOUSSONG, kpd_input_dev->keybit);
	__set_bit(KEY_NEXTSONG, kpd_input_dev->keybit);
