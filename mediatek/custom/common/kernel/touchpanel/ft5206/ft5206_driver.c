...
#include <linux/lenovo_interface.h>
...
#if defined(LENOVO_PROJECT_P700I)
//#define CONFIG_SUPPORT_FTS_CTP_UPG  //zhangjiano add fireware update fution 
//#define AUTO_CLB
#endif
...
{
#include "ver81_P700i_ofilm0x51_20120723_app.i"
};
...
if(0xa8 != ft5x0x_read_ID_ver())
{
   ...
   if (i_ret != 0)
   {
	...
	printk("[TSP] Step 9:auto clb finish!\n");
#endif
	msleep(200);  
...
reset_proc:   
  ...
  mt_set_gpio_dir(GPIO_CTP_EN_PIN, GPIO_DIR_OUT);
	...
	msleep(100);
	fts_ctpm_fw_upgrade_with_i_file(i2c_client);
...
/*Begin lenovo-sw wengjun1 add for p700 tpd common-mode interference 2012-6-26*/ 
#if defined(LENOVO_PROJECT_P700I) 
void usb_connect_write_tpd(void)
{
	   kal_uint8 data = 0x02;
	   if((i2c_smbus_write_i2c_block_data(i2c_client, 0x86, 1,  &data))< 0)
	   {
		   printk("I2C read report rate error, line: %d\n", __LINE__);
	   }
	printk("[wj]write tpd reg 0x86 value:0x02\n");
}
void usb_disconnect_write_tpd(void)
{
	   kal_uint8 data = 0x01;
	   if((i2c_smbus_write_i2c_block_data(i2c_client, 0x86, 1,  &data))< 0)
	   {
	...
	printk("[wj]write tpd reg 0x86 value:0x01\n");
}
#endif
/*End lenovo-sw wengjun1 add for p700 tpd common-mode interference 2012-6-26*/ 
